      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-[#EAF1F4]">
            ...
            <th className="text-left py-3 px-4 text-xs font-semibold text-[#5E7480] uppercase tracking-wider">ID</th>
        ...
        <tbody>
          {patients.map((patient) => (
            ...
            >
              ...
              <td className="py-4 px-4">
                <span className="text-sm font-mono text-[#5E7480]">{patient.id}</span>
              </td>
              <td className="py-4 px-4">
